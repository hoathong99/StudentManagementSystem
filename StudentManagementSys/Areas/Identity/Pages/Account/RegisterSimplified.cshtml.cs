...
namespace StudentManagementSys.Areas.Identity.Pages.Account
{
    public class RegisterModelSimplified : PageModel
    {
            ...
            )
        {
            ...
            _StuService = new StudentServices(studentManagementSysContext, userManager);
            _context = studentManagementSysContext;
            _StaService = new StaffServices(studentManagementSysContext, userManager);
        }
        ...
        public class InputModel
        {
            ...
            public IEnumerable<SelectListItem> AccountTypeLst { get; set; }
        }
            ...
            //if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if(Input.AccountType == "student")
                    {
                        ...
                        temp.Authority = Input.Role;
                        temp.Name = user.UserName;
                        temp.SchoolSession = "20201";
                        temp.Status = "active";
                        temp.Type = "student";
                        await _StuService.RegisterStudentAsync(temp);
                    }
                    if (Input.AccountType == "staff")
                    {
                        var temp2 = new StaffDto();
                        temp2.AccountId = user.Id;
                        temp2.Authority = Input.Role;
                        temp2.Name = user.UserName;
                        temp2.Status = "active";
                        temp2.Type = "staff";
                        await _StaService.RegisterStaffAsync(temp2);
                    }
